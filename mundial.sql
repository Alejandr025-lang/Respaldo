...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-05-2026 a las 17:30:43
...
--
ALTER TABLE `jugador`
  ADD CONSTRAINT `jugador_ibfk_1` FOREIGN KEY (`id_jugador`) REFERENCES `equipo` (`id_equipo`);

--
-- Filtros para la tabla `partido`
--
ALTER TABLE `partido`
  ADD CONSTRAINT `partido_ibfk_1` FOREIGN KEY (`id_partido`) REFERENCES `estadio` (`id_estadio`),
  ADD CONSTRAINT `partido_ibfk_2` FOREIGN KEY (`id_partido`) REFERENCES `equipo` (`id_equipo`),
  ADD CONSTRAINT `partido_ibfk_3` FOREIGN KEY (`id_partido`) REFERENCES `equipo` (`id_equipo`);
COMMIT;
